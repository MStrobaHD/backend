        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CloudAsset>(entity =>
            {
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CLOUDASS_REFERENCE_COURSE");
            ...
            modelBuilder.Entity<Lesson>(entity =>
            {
                ...
                entity.HasOne(d => d.CloudAsset)
                    .WithMany(p => p.Lesson)
                    .HasForeignKey(d => d.CloudAssetId)
                    .HasConstraintName("FK_LESSON_REFERENCE_CLOUDASS");
                ...
                entity.HasOne(d => d.ServerAsset)
                    .WithMany(p => p.Lesson)
                    .HasForeignKey(d => d.ServerAssetId)
                    .HasConstraintName("FK_LESSON_REFERENCE_SERVERAS");
            });
            ...
            modelBuilder.Entity<ServerAsset>(entity =>
            {
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .HasForeignKey(d => d.CourseId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SERVERAS_REFERENCE_COURSE");
